...
- `src/render.v`: plain-text rendering for the typed AST
- `src/render_html.v`: bounded direct HTML rendering through md4c-html
- `src/render_json.v`: JSON rendering for the typed AST
- `src/render_markdown.v`: normalized Markdown rendering for the typed AST

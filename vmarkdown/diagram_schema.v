...
pub fn validate_diagram_json_raw(kind string, raw string) !string {
	return match kind {
		...
		'pipeline' {
			input := json.decode(PipelineInput, raw)!
		...
		'state' {
			input := json.decode(StateMachineInput, raw)!

...
pub type DiagramSequenceEvent = DiagramSequenceActivation | DiagramSequenceBlockBoundary | DiagramSequenceMessage | DiagramSequenceNote
...
pub type DiagramPayload = DiagramClassDiagram | DiagramERDiagram | DiagramGantt | DiagramGitGraph | DiagramGraph | DiagramJourney | DiagramOrgChart | DiagramPipeline | DiagramSequence | DiagramStateMachine | DiagramTimeline | DiagramTree
...
pub fn render_diagram_payload(payload DiagramPayload, width int) string {
	...
	return match payload {
		...
		DiagramOrgChart {
			render_ascii_org_chart(payload.to_ascii_org(), if safe_width < 40 { 40 } else { safe_width })
		}
		DiagramTimeline {

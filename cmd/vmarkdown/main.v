...
fn usage() string {
  ...
  v run cmd/vmarkdown mermaid <file.mmd> [--width N]
  v run cmd/vmarkdown mermaid diff <before.mmd> <after.mmd>
  v run cmd/vmarkdown mermaid diff-preview <before.mmd> <after.mmd>
  v run cmd/vmarkdown mermaid-preview <file.mmd>
  v run cmd/vmarkdown mermaid-diff <before.mmd> <after.mmd>
  v run cmd/vmarkdown diagrams-demo
  v run cmd/vmarkdown diagram <tree|dependency|call|org|timeline|pipeline|state> [input.json] [--width N]
  v run cmd/vmarkdown diagram preview <tree|dependency|call|org|timeline|pipeline|state> [input.json] [--width N]
  v run cmd/vmarkdown diagram diff <tree|dependency|call|org|timeline|pipeline|state> <before.json> <after.json>
  v run cmd/vmarkdown diagram diff-preview <tree|dependency|call|org|timeline|pipeline|state> <before.json> <after.json>
  v run cmd/vmarkdown diagram schema <all|tree|dependency|call|org|timeline|pipeline|state>
  v run cmd/vmarkdown diagram validate <tree|dependency|call|org|timeline|pipeline|state> <input.json>'
}

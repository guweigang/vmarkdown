...
fn test_html_to_markdown_inline_image_keeps_surrounding_text() {
	markdown := html_to_markdown('<p>before <img src="https://example.com/a(b c).png" alt="diagram"> after</p>') or {
		panic(err)
	}
	assert markdown == 'before ![diagram](<https://example.com/a(b c).png>) after'
}
